...
function bs_shortcodes_add_buttons( $plugin_array ) {
    ...
    $plugin_array['bs_tabs'] = plugins_url( '/bootstrap-shortcodes/js/bootstrap-shortcodes-tinymce-buttons.js' );
    $plugin_array['bs_collapse'] = plugins_url( '/bootstrap-shortcodes/js/bootstrap-shortcodes-tinymce-buttons.js' );
